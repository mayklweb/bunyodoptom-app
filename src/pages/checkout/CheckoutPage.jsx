...
export function CheckoutPage() {
  ...
  const { cart, selectedIds, clearSelected } = useCartStore();
  ...
  const totalCount = selectedProducts.reduce((sum, item) => sum + item.qty, 0);
                ...
                {markets.map((market) => (
                  ...
                  >
                    ...
                    <div className="flex-1 text-sm">
                      ...
                      <p className="text-gray-500 text-xs">{market.address}</p>
                    </div>
                  </label>
                ))}
              </div>
